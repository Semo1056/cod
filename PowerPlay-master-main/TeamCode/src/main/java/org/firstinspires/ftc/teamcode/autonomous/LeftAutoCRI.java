...
@Autonomous(name ="LeftHighCRI", group = "Test")
public class LeftAutoCRI extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(opModeIsActive() && !isStopRequested()) {
            ...
            if(sleeveDetection.getPosition()== SleeveDetectionLeft.ParkingPosition.RIGHT){
                stacking(6, 13);
            }else if(sleeveDetection.getPosition()== SleeveDetectionLeft.ParkingPosition.CENTER){
                stacking(-19, 13);
            }else if(sleeveDetection.getPosition()== SleeveDetectionLeft.ParkingPosition.LEFT){
                stacking(-46, 10);
            }
    ...
    public void stacking(double x , double y){
        ...
        pos1 = drive.trajectorySequenceBuilder(startPose)
                .lineToConstantHeading(new Vector2d(-39, -6.4),SampleMecanumDrive.getVelocityConstraint(60, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .turn(Math.toRadians(-82.5))
                .build();


        transformer = drive.trajectorySequenceBuilder(pos1.end())
                .lineToLinearHeading(new Pose2d(-49, 15.476, Math.toRadians(-17.18)),SampleMecanumDrive.getVelocityConstraint(60, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

       placeTransformer = drive.trajectoryBuilder(transformer.end())
                   .lineToLinearHeading(new Pose2d(-47, 12, Math.toRadians(-18.87)),SampleMecanumDrive.getVelocityConstraint(60, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                   .build();

       parcare = drive.trajectorySequenceBuilder(placeTransformer.end())
               .lineToLinearHeading(new Pose2d(-46, 12, Math.toRadians(20)),SampleMecanumDrive.getVelocityConstraint(70, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
               .lineToLinearHeading(new Pose2d(x, y, Math.toRadians(90)),SampleMecanumDrive.getVelocityConstraint(80, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
        ...
        teleop.intake.intakeClaw.setPosition(0);
        ...
        teleop.vertical.outTakeClaw.setPosition(teleop.vertical.closedClaw);
        HighAutoTransformer();
        teleop.vertical.AlignerServo.setPosition(1);
        teleop.vertical.OutTakeUpAuto();
        drive.followTrajectory(placeTransformer);
        sleep(100);
        placeCone();
        sleep(150);
        teleop.vertical.outTakeClaw.setPosition(0.9);
    ...
    public void farauncon(double x , double y){
        ...
        transformer = drive.trajectorySequenceBuilder(pos1.end())
                .lineToLinearHeading(new Pose2d(-49, 15.476, Math.toRadians(-17.18)),SampleMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        placeTransformer = drive.trajectoryBuilder(transformer.end())
                .lineToLinearHeading(new Pose2d(-49, 12, Math.toRadians(-18.87)),SampleMecanumDrive.getVelocityConstraint(60, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        parcare = drive.trajectorySequenceBuilder(placeTransformer.end())
                .lineToLinearHeading(new Pose2d(-41, 15, Math.toRadians(20)),SampleMecanumDrive.getVelocityConstraint(70, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .lineToLinearHeading(new Pose2d(x, y, Math.toRadians(20)),SampleMecanumDrive.getVelocityConstraint(80, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(0.01, () -> {
                    parkingRetract();
                })
                .build();
    ...
    public void collectFirst(){
        ...
        teleop.intake.intakeLeft.setPosition(0.85);
        teleop.intake.ArmRight.setPosition(0.445);
        teleop.intake.ArmLeft.setPosition(0.445);
        teleop.intake.UpAndDown.setPosition(0.215);
        teleop.intake.intakeClaw.setPosition(0.01);
    }
    ...
    public void collectSecond(){
        ...
        teleop.intake.intakeRight.setPosition(0.78);
        teleop.intake.intakeLeft.setPosition(0.78);
        teleop.intake.ArmRight.setPosition(0.39);
        teleop.intake.ArmLeft.setPosition(0.39);
        teleop.intake.UpAndDown.setPosition(0.19);
        teleop.intake.intakeClaw.setPosition(0.01);
    }
    ...
    public void collectThird(){
        //teleop.vertical.outTakeLeft.setPosition(1.02 - teleop.vertical.outTakeDown);
        //teleop.vertical.outTakeRight.setPosition(teleop.vertical.outTakeDown);
        teleop.intake.intakeRight.setPosition(0.755);
        teleop.intake.intakeLeft.setPosition(0.755);
        teleop.intake.ArmLeft.setPosition(0.31);
        teleop.intake.ArmRight.setPosition(0.31);
    ...
    public void collectFourth(){
        ...
        teleop.intake.ArmLeft.setPosition(0.22);
        teleop.intake.ArmRight.setPosition(0.22);
        teleop.intake.UpAndDown.setPosition(0.13);
        teleop.intake.intakeClaw.setPosition(0.01);
    }
    ...
    public void downLiftAuto() {
        ...
        //MOTOARE
        teleop.vertical.AlignerServo.setPosition(0.8);
    ...
    public void HighAutoTransformer() {
        ...
        teleop.vertical.liftLeft.setTargetPosition(500);
        teleop.vertical.liftRight.setTargetPosition(500);
