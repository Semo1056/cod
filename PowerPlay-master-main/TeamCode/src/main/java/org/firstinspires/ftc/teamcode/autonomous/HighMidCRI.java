...
@Autonomous(name ="HighMidCRI", group = "Test")
public class HighMidCRI extends LinearOpMode {
...
//    double turnValue = -78;
    ...
    public void stacking(double x , double y){
        ...
        transformer = drive.trajectorySequenceBuilder(pos1.end())
                .lineToLinearHeading(new Pose2d(-45.5, 17.476, Math.toRadians(-14.6)),SampleMecanumDrive.getVelocityConstraint(60, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .back(2)
                .build();
